...
type ReptileTemperatureAndHumidityLogContext = {
  ...
  handleModifyReptileTemperatureAndHumidityLogModalOpen: (reptileTemperatureAndHumidityLog: ReptileTemperatureAndHumidityLog | undefined) => void,
  handleModifyReptileTemperatureAndHumidityLogModalClose: () => void,
  handleReptileTemperatureAndHumidityLogsDelete: (reptileTemperatureAndHumidityLogIds: string[]) => void
  ...
  handleModifyReptileTemperatureAndHumidityLogModalOpenInReptileTable: (reptile: Reptile, reptileTemperatureAndHumidityLog: ReptileTemperatureAndHumidityLog) => void;
};

export const ReptileTemperatureAndHumidityLogContext = createContext<ReptileTemperatureAndHumidityLogContext>(
  {} as ReptileTemperatureAndHumidityLogContext
);

export const ReptileTemperatureAndHumidityLogProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [editableReptileTemperatureAndHumidityLog, setEditableReptileTemperatureAndHumidityLog] = useState<ReptileTemperatureAndHumidityLog | undefined>();
  ...
  const [currentReptileTemperatureAndHumidityLog, setCurrentReptileTemperatureAndHumidityLog] = useState<ReptileTemperatureAndHumidityLog | undefined>();


  const handleModifyReptileTemperatureAndHumidityLogModalOpen = (reptileTemperatureAndHumidityLog: ReptileTemperatureAndHumidityLog | undefined) => {
  ...
  const handleReptileTemperatureAndHumidityLogsDelete = async (reptileTemperatureAndHumidityLogIds: string[]) => {
    for await (const reptileTemperatureAndHumidityLogId of reptileTemperatureAndHumidityLogIds) {
      await reptileRepository.removeReptileTemperatureAndHumidityLog(reptileTemperatureAndHumidityLogId);
    }
    await reptileRepository.fetchAll();
  };

  const handleModifyReptileTemperatureAndHumidityLogModalOpenInReptileTable = (reptile: Reptile, reptileTemperatureAndHumidityLog: ReptileTemperatureAndHumidityLog) => {
  ...
  useEffect(() => {
    if (currentReptileTemperatureAndHumidityLog) handleModifyReptileTemperatureAndHumidityLogModalOpen(currentReptileTemperatureAndHumidityLog);
  }, [reptileTemperatureAndHumidityLogs]);

  useEffect(() => {
    if (currentReptileTemperatureAndHumidityLog && !ModalToggle) handleModifyReptileTemperatureAndHumidityLogModalCloseInReptileTable();
  }, [ModalToggle]);
