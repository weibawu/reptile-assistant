...
const ReptileTemperatureAndHumidityLogs: React.FC<ReptileTemperatureAndHumidityLogsProps> = ({
  viewableReptile,
}) => {
  const { loading, currentUserDisplayedUsername, reptiles, reptileTemperatureAndHumidityLogs } =
            ...
            <Card>
              {!viewableReptile ? (
                ...
                <TemperatureAndHumidityLogsTable
                  ...
                  reptileTemperatureAndHumidityLogs={reptileTemperatureAndHumidityLogs.filter(
                    (reptileTemperatureAndHumidityLog) =>
                      reptileTemperatureAndHumidityLog.reptileID === viewableReptile?.id,
                  )}
                  onReptileTemperatureAndHumidityLogEditing={
                    handleModifyReptileTemperatureAndHumidityLogModalOpen
                  }
