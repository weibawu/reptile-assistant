...
interface ReptileTemperatureAndHumidityLogsTableProps {
  ...
  reptiles: Reptile[];
  onReptileTemperatureAndHumidityLogEditing: (reptileTemperatureAndHumidityLog: ReptileTemperatureAndHumidityLog) => any;
  onReptileTemperatureAndHumidityLogsDeleting: (reptileTemperatureAndHumidityLogIds: string[]) => any;
}
...
const ReptileTemperatureAndHumidityLogsTable: FC<ReptileTemperatureAndHumidityLogsTableProps> =
  ({
    ...
    const [selectedReptileTemperatureAndHumidityLogs, setSelectedReptileTemperatureAndHumidityLogs] = useState<string[]>(
      []
    );
    ...
    const handleSelectAllReptileTemperatureAndHumidityLogs = (
      ...
      setSelectedReptileTemperatureAndHumidityLogs(
        event.target.checked
          ? reptileTemperatureAndHumidityLogs.map((reptileTemperatureAndHumidityLogs) => reptileTemperatureAndHumidityLogs.id)
          : []
      );
    };
    ...
    const getReptileFromReptileTemperatureAndHumidityLog:
      (reptileTemperatureAndHumidityLog: ReptileTemperatureAndHumidityLog) => Reptile
      = (reptileTemperatureAndHumidityLog) =>
      reptiles.find(
        reptile => reptile.id === reptileTemperatureAndHumidityLog.reptileID
      )!;
          ...
          <Table>
            ...
            <TableBody>
              {paginatedReptileTemperatureAndHumidityLogs.map((reptileTemperatureAndHumidityLog) => {
                const isReptileTemperatureAndHumidityLogSelected = selectedReptileTemperatureAndHumidityLogs.includes(
                  ...
                  >
                    <TableCell padding="checkbox">
                      <Checkbox
                        ...
                        onChange={(event: ChangeEvent<HTMLInputElement>) =>
                          handleSelectOneReptileTemperatureAndHumidityLog(event, reptileTemperatureAndHumidityLog.id)
                        }
                    ...
                    <TableCell>
                      <Typography
                        ...
                        noWrap
                      >
                        {getReptileFromReptileTemperatureAndHumidityLog(reptileTemperatureAndHumidityLog).name}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography
                        ...
                        noWrap
                      >
                        {getReptileFromReptileTemperatureAndHumidityLog(reptileTemperatureAndHumidityLog).gender === 'MALE' ? '公' : '母'}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography
                        ...
                        noWrap
                      >
                        {(getReptileFromReptileTemperatureAndHumidityLog(reptileTemperatureAndHumidityLog).genies ?? []).map(genie => getTextLabel(genie!))}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography
                    ...
                    <TableCell>
                      <Typography
                        ...
                        noWrap
                      >
                        {format(new Date(reptileTemperatureAndHumidityLog.meteringDateTime!), 'yyyy年MM月dd日 hh:mm:ss')}
                      </Typography>
                    </TableCell>
                    <TableCell align="right">
                      <Tooltip title="编辑" arrow>
                        <IconButton
                          ...
                          color="inherit"
                          size="small"
                          onClick={onReptileTemperatureAndHumidityLogEditing.bind(null, reptileTemperatureAndHumidityLog)}
                        >
                      ...
                      <Tooltip title="删除" arrow>
                        <IconButton
                          ...
                          color="inherit"
                          size="small"
                          onClick={onReptileTemperatureAndHumidityLogsDeleting.bind(null, [reptileTemperatureAndHumidityLog.id])}
                        >
