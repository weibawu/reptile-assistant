...
const ReptileFeedingLogsTable: FC<ReptileFeedingLogsTableProps> =
  ({
    ...
    const getReptileFromReptileFeedingLog:
      (reptileFeedingLog: ReptileFeedingLog) => Reptile
      = (reptileFeedingLog) =>
      reptiles.find(
        reptile => reptile.id === reptileFeedingLog.reptileID
      )!;
                  ...
                  >
                    ...
                    <TableCell>
                      <Typography
                        ...
                        noWrap
                      >
                        {getReptileFromReptileFeedingLog(reptileFeedingLog).gender === 'MALE' ? '公' : '母'}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography
